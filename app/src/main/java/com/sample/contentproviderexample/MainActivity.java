...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String CONTENT_URI = "content://com.sample.contentproviderexample/world";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleCursorAdapter ca = new SimpleCursorAdapter(this, android.R.layout.simple_list_item_2, cursor, new String[] {"country", "capital"},  new int[] {android.R.id.text1, android.R.id.text2});
